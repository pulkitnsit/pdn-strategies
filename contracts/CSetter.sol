...
contract CSetter is PoolToken, CStorage {
    ...
    function _initialize(
        ...
        require(msg.sender == factory, "Lpmaxi: UNAUTHORIZED"); // sufficient check
        _setName(_name, _symbol);
        underlying = _underlying;
        borrowable0 = _borrowable0;
        borrowable1 = _borrowable1;
        lpmaxiPriceOracle = IFactory(factory).lpmaxiPriceOracle();
    }
    ...
    function _checkSetting(
        ...
        _checkAdmin();
        require(parameter >= min, "Lpmaxi: INVALID_SETTING");
        require(parameter <= max, "Lpmaxi: INVALID_SETTING");
    }

    function _checkAdmin() internal view {
        require(msg.sender == IFactory(factory).admin(), "Lpmaxi: UNAUTHORIZED");
    }
}
