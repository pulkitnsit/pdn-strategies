...
import "./LpmaxiERC20.sol";
import "./interfaces/IERC20.sol";
import "./interfaces/IPoolToken.sol";
import "./libraries/SafeMath.sol";

contract PoolToken is IPoolToken, LpmaxiERC20 {
    ...
    function _setFactory() external {
        require(factory == address(0), "Lpmaxi: FACTORY_ALREADY_SET");
        factory = msg.sender;
    }
        ...
        returns (uint256 mintTokens)
    {
        ...
        require(mintTokens > 0, "Lpmaxi: MINT_AMOUNT_ZERO");
        ...
        returns (uint256 redeemAmount)
    {
        ...
        require(redeemAmount > 0, "Lpmaxi: REDEEM_AMOUNT_ZERO");
    ...
    modifier nonReentrant() {
        require(_notEntered, "Lpmaxi: REENTERED");
        _notEntered = false;
        _;
        _notEntered = true;
    }
